...
public class DataMungingConsoleAppTest {
    ...
    @Test
    public void given_weatherDatFile_when_fixWidthParser_then_dayWithSmallestRSpreadIs14() throws Exception {
        String file = Paths.get(WeatherFixture.getDatFile()).toString();
        String[] arguments = {
                "--" + FIRST_LINE_IS_HEADER,
                "--" + SKIP_EMPTY_LINES,
    ...
    @Test
    public void given_footballDatFile_when_fixWidthParser_then_smallestDifferenceInGoalsIsAstonVilla() throws Exception {
